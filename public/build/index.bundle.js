	...
	var App = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_componentsNavtreeNavtreeJsx2['default'], { ref: "navtree", height: this.state.height }),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Navtree = _react2['default'].createClass({
	    ...
	    render: function render() {
	        return _react2['default'].createElement(
	            'section',
	            { className: "navtree hidden", style: { height: this.props.height } },
	            _react2['default'].createElement(
	                'header',
	                null,
	                _react2['default'].createElement(
	                ...
	                _react2['default'].createElement(
	                    ...
	                    _react2['default'].createElement(
	                        'a',
	                        { href: "javascript:void(0);", className: "nav-accounts" },
	                        '登录/注册'
	                    )
	                )
	            ),
	            _react2['default'].createElement(
	                'div',
	                { className: "nav-wrap", style: { height: this.props.height } },
	                _react2['default'].createElement(
	                    'div',
	                    { className: "search" },
	                    _react2['default'].createElement(
	                        'form',
	                        { action: "https://api.douban.com/v2/movie/search?q=" },
